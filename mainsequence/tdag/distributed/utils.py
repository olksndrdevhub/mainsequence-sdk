...
def build_ts_updater_serve_request(pickle_path:str,update_priority:int,scheduler_uid:str,
    ...
    query = dict(scheduler_uid=scheduler_uid, telemetry_carrier=telemetry_carrier,
...
def do_remote_update_by_hash_id(hash_id: str, update_priority: int, scheduler_uid: str,
