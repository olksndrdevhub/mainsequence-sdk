    ...
    slide_layout = GridLayout(
        ...
        cells=[
            ...
            GridCell(row=2, col=1, element=TextElement(
                ...
                color=main_sequence_blue, h_align=HorizontalAlign.left, v_align=VerticalAlign.center
...
def pie_chart_bars_slide() -> Slide:
    pie_chart_slice_colors = ['#B2DFDB', main_sequence_blue, '#4A90E2']
    current_section_title_font_size = 16
    ...
    slide_layout = GridLayout(
        ...
        cells=[
            GridCell(row=1, col=1, element=TextElement(
                ...
                font_size=current_section_title_font_size, font_weight=FontWeight.bold,
                color=main_sequence_blue, h_align=HorizontalAlign.left
            ...
            GridCell(row=1, col=2, element=TextElement(
                text="Duration Breakdown", font_size=current_section_title_font_size, font_weight=FontWeight.bold,
                color=main_sequence_blue, h_align=HorizontalAlign.left
            ), align_self=VerticalAlign.bottom, padding="0 0 2px 0"),
