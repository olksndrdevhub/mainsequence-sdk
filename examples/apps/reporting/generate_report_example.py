...
def generate_report():
    ...
    # 4) Build the template context with your metadata and the embedded charts.
    ...
    template_context = {
        ...
        "summary": (
            "We are entering a more benign phase of the economic cycle characterized by sustained economic growth "
            "and declining policy interest rates. Historically, such an environment supports equities but also highlights "
            "the increasing importance of broad diversification across regions and sectors."
        ),
        "pdf_path": "weasy_output_report.pdf",

        # Report content: 2 pages, including the embedded images.
        "report_content": f"""
            <h2>Overview</h2>
            <p>
    ...
    # 7) Optional: Convert the HTML to PDF using WeasyPrint
