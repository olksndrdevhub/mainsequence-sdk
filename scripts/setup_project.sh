...
if [ ! -d "$VFB_PROJECT_PATH" ]; then
  ...
  cp -a "/opt/code/mainsequence-sdk/contrib/time_series/*" "$VFB_PROJECT_PATH/time_series" || echo "WARNING: Copy TimeSeries step failed!"
  cp -a "/opt/code/mainsequence-sdk/contrib/rebalance_strategies/*" "$VFB_PROJECT_PATH/rebalance_strategies" || echo "WARNING: Copy Rebalance Strategies step failed!"
  cp -a "/opt/code/mainsequence-sdk/contrib/apps/*" "$VFB_PROJECT_PATH/apps" || echo "WARNING: Copy apps step failed!"
