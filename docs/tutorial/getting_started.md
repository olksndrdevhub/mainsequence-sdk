...
Also make sure you have Python 3.11 or later installed or download it from the official site.
...
Open PowerShell in VS Code, activate your virtual environment and install `uv`:
...
If your project depends on environment variables, verify they're set (for example, `VFB_PROJECT_PATH`). You can check environment variables in PowerShell with:
